        ...
        <div class="flex flex-col md:flex-row justify-between items-start">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ $socialLinks->instagram }}" target="_blank" class="flex items-center text-gray-300 hover:text-emerald-400 transition-colors duration-300">
                    ...
                    <a href="{{ $socialLinks->telegram }}" target="_blank" class="flex items-center text-gray-300 hover:text-emerald-400 transition-colors duration-300">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $socialLinks->facebook }}" target="_blank" class="flex items-center text-gray-300 hover:text-emerald-400 transition-colors duration-300">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
